    ...
    <form class="form_create_profile" method="POST" action="{{route("icons.show")}}" enctype="multipart/form-data" >
        ...
        <table class="form_create_table" >
            ...
            <tr>
                ...
                <td><input type="text" required value="2"  name="lv" id="level"></td>
            </tr>
            <tr>
                <td class="forn_create_head">Avata *</td>
                <td><img src="{{(empty($image)?"":$image)}}" alt=""></td>
            </tr>
         <tr>
                <td class="forn_create_head">Avata</td>
                <td>
                    <div class="content_upload_img">
                        ...
                        <input required type="file" hidden id="mypicture" name="upLoadAvata">
                    </div>
                </td>
            </tr>
        ...
        <div class="container_footer">
            <button type="submit" name="change_Icons" value="2">Add Icons</button>
